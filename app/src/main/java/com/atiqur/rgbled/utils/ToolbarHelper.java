...
//        activity.getSupportActionBar().setHomeAsUpIndicator(upArrow);
    ...
    public static com.atiqur.rgbled.utils.ToolbarHelper create(Toolbar toolbar, CollapsingToolbarLayout collapsingToolbarLayout, AppCompatActivity activity, String title) {
        return new com.atiqur.rgbled.utils.ToolbarHelper(toolbar, collapsingToolbarLayout, activity, title);
    }
